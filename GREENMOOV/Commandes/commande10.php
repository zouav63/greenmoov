<?php 
    ...
    function getliste($conn){
        $sql = "SELECT * FROM `panier` WHERE type=10";
        ...
        if($result->num_rows > 0) { 
            ...
            echo '<li>Pas de fruits et légumes pour la semaine</li>';
        }
    }
?>
...
<html>
    ...
    <body>
    <h3 class="title" style="text-align:center; margin:3rem;"> Vous avez choisi le panier à 10&#x20AC</h3>   
    <?php 
        if($_GET['commande']==1){
    ...
    <div id="container">
            <div id="validation">
                ...
                <ul class="panier">
                        ...
                        <?php getliste($conn)?>
                        <div class="change">
                            <form action="./include/modifliste.inc.php?panier=10" method="post" class='form'>
                                <div id='liste'>
          ...
          <!-- J'utilise souvent l'attribut value pour vérifier son statut (si admin/membre alors peut éditer -> JS)-->
    ...
    <!-- Vérification que l'utilisateur est bien login pour passer commande parce que même si il y a une première vérification dans le main, il peut toujours y accéder en tapant l'url-->
                    <form action="<?php if(isset($_SESSION['email'])){echo './include/commande.inc.php?panier=10';}else{echo '../login/login.php';}?>" method="post"> 
